...
pub fn resolve(addr: &str, ip_addr_type: IpAddrType) -> ProxyResult<Vec<DnsResolutionInfo>> {
    // IDNA parsing
...
pub fn resolve_single(addr: &str, ip_addr_type: IpAddrType) -> ProxyResult<DnsResolutionInfo> {
